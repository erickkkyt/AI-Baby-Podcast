  ...
  return (
    <div className="container mx-auto max-w-3xl px-4 py-10 text-gray-800 dark:text-gray-200 font-sans">
      ...
      <section className="mb-8 p-6 bg-white dark:bg-gray-800 shadow-lg rounded-lg">
        ...
        <p>
          8.3. Third-party services involved, including Google Login, are not under our control, and we do not review, approve, monitor, endorse, warrant, or make any representations and warranties, express or implied with respect to third party services and are not responsible for any third-party service.
        </p>
      </section>
      ...
      <section className="mb-8 p-6 bg-white dark:bg-gray-800 shadow-lg rounded-lg">
        ...
        <p>
          9.2. You agree to indemnify and hold us harmless from any claims, damages, or expenses arising from:
        </p>
      ...
      <section className="mb-8 p-6 bg-white dark:bg-gray-800 shadow-lg rounded-lg">
        ...
        <p className="mb-2">
          10.2. YOU SHALL USE THE SERVICES PROVIDED BY US AND AI Baby Podcast OUTPUTS IN STRICT ACCORDANCE WITH THIS AGREEMENT. WE ARE NOT LIABLE FOR LOSSES ARISING FROM YOUR BREACH OF THESE TERMS OR ANY OF OUR OTHER RULES.
        </p>
        <p className="mb-2">
          10.3. WE WILL NOT BE LIABLE TO YOU OR ANY OTHER INDIVIDUAL OR ENTITY FOR ANY INDIRECT DAMAGES.
        </p>
        <p>
          10.4. IN NO EVENT SHALL OUR AGGREGATE LIABILITY FOR COMPENSATION UNDER THIS TERMS (WHETHER IN CONTRACT, TORT OR OTHERWISE) EXCEED THE HIGHER OF THE TOTAL FEES PAID BY YOU TO US FOR YOUR USE OF THE SERVICES HEREUNDER DURING THE TWELVE (12) MONTHS IMMEDIATELY PRIOR TO THE EVENT OR CIRCUMSTANCE GIVING RISE TO SUCH LIABILITY.
        </p>
      </section>
      ...
      <section className="mb-8 p-6 bg-white dark:bg-gray-800 shadow-lg rounded-lg">
        ...
        <p>
          12.4. We may seek injunctive or equitable relief in any competent court where you are permanently located, as necessary to protect our rights or interests.
        </p>
      </section>
      ...
      <section className="mb-8 p-6 bg-white dark:bg-gray-800 shadow-lg rounded-lg">
        ...
        <p className="mb-2">
          13.2. These Terms represent the entire agreement between you and us regarding the Service.
        </p>
        <p className="mb-2">
          13.3. You may not assign these Terms without our consent. We may assign them freely.
        </p>
        <p>
          13.4. Our failure to enforce any provision shall not constitute a waiver.
        </p>
      </section>
