...
export const metadata: Metadata = {
  ...
  title: 'Pricing Plans - AI Baby Podcast Generator',
  description: 'Explore flexible pricing plans for the AI Baby Podcast Generator. Find the perfect option to create unique baby videos, from free trials to premium features.',
  openGraph: {
    title: 'Pricing Plans - AI Baby Podcast Generator',
    description: 'Explore flexible pricing plans for the AI Baby Podcast Generator. Find the perfect option to create unique baby videos, from free trials to premium features.',
