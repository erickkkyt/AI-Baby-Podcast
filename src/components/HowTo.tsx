...
export default function HowTo() {
  ...
  return (
    <section id="how-it-works" className="py-20 bg-gray-50">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">        <div className="text-center mb-16">          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">How To Create AI Baby Generator Content</h2>          <p className="text-xl text-gray-600 max-w-3xl mx-auto">            Follow these steps to create engaging AI Baby Generator videos          </p>        </div>
